...
export default function ServicesSection() {
  ...
  const services = [
    ...
    },
    {
      ...
      image: '/images/wedding-outdoor.jpg',
    },
    {
      id: 3,
      titleKey: 'photobooth',
      descKey: 'photoboothDesc',
      image: '/images/photobooth-wedding.jpg',
    },
  ];
    ...
    <section id='services' className='py-24 px-4 sm:px-6 lg:px-8 bg-background'>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='text-center mb-20 space-y-4'>
          <h2 className='text-5xl sm:text-6xl font-serif font-light tracking-tight text-balance'>
            {t('ourServices')}
          </h2>
