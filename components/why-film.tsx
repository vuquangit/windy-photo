      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-muted">
            <img src="/film-photography-black-and-white-artistic.jpg" alt="Film photography art" className="w-full h-full object-cover" />
          </div>

          {/* Right: Text */}
          <div className="flex flex-col justify-start pt-8 space-y-6">
            <h2 className="text-4xl font-serif font-light italic">{content.title}</h2>
            <div className="space-y-4">
              <p className="text-sm leading-relaxed text-muted-foreground">{content.description1}</p>
              <p className="text-sm leading-relaxed text-muted-foreground">{content.description2}</p>
            </div>
          </div>
        </div>
      </div>
