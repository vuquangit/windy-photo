        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">{content.goal}</p>
            </div>
            <button className="inline-block px-6 py-3 border border-foreground text-foreground hover:bg-foreground hover:text-background transition-colors">
              {content.cta}
            </button>
          </div>
          ...
          <div className="relative aspect-[3/4] rounded-lg overflow-hidden bg-muted">
            <img
              src="/professional-photographer-woman-with-camera.jpg"
